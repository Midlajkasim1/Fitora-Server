      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 md:gap-4 mt-1">
            <span className={`text-[8px] md:text-[9px] font-black px-2 py-0.5 rounded uppercase italic ${
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="flex items-center gap-2 flex-1 md:flex-none">
          ...
          <button 
            ...
            className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-6 py-3 font-black text-[9px] md:text-[10px] rounded-xl transition uppercase italic md:ml-2 ${
              isCompleted 
