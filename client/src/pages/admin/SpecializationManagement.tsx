...
import { useSpecializationManagement } from "../../hooks/admin/use-admin-specializations";
...
import { useSpecializationToggleBlock } from "../../hooks/admin/use-SpecializationToggleBlock";
