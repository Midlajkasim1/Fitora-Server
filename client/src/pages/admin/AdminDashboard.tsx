      ...
      <main className="flex-1 ml-64 flex flex-col">
        ...
        <div className="p-10 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {[
              { label: "Total Revenue", val: "0", change: "12%", icon: TrendingUp },
              { label: "Total Users", val:"0", change: "5%", icon: Users },
              { label: "Total Trainers", val: "0", change: "3%", icon: GraduationCap },
              { label: "Total Specialization", val: "0", change: "1%", icon: Grid },
            ].map((stat) => (
