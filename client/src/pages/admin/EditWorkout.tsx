...
import { editWorkoutSchema } from "../../validators/admin/EditWorkout.Schema";
...
export default function EditWorkoutPage() {
  ...
  const {
    ...
    const onSubmit = (formData: EditWorkoutFormData) => {
        toast.loading("Updating workout...", { id: "update" });
            ...
            <div className="p-10 space-y-10 max-w-6xl">
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full bg-[#0d1f17] border border-white/10 rounded-xl py-3 px-4 text-white"
                            />
                            {errors.description && (
                                <p className="text-red-400 text-sm mt-1">
                    ...
                    <div className="flex justify-end gap-4 pt-4 border-t border-white/5">
                        ...
                        >
                            {mutation.isPending ? "Updating..." : "Update Workout"}
                        </button>
                    </div>
