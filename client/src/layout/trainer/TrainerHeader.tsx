...
export const TrainerHeader = () => {
  ...
  return (
    ...
    <header className="h-20 border-b border-white/5 bg-[#06110d]/50 backdrop-blur-md px-8 flex items-center justify-end gap-6 relative z-[60]">
      
      {/* ✅ Cleanly use the separate component */}
      <NotificationBell />
