...
import { UpdateStatusRequestDTO } from "@/application/dto/specialization/request/update.status.specialization.dto";
...
import { UpdateStatusResponseDTO } from "@/application/dto/specialization/response/update.status.specialization.dto";
