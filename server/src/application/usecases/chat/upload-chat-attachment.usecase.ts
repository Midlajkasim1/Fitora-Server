...
export class UploadChatAttachmentUseCase implements IBaseUseCase<any, UploadChatAttachmentResponse, UploadFileDTO> {
  constructor(private readonly _storageProvider: IStorageProvider) {}

  async execute(_dto: any, file: UploadFileDTO): Promise<UploadChatAttachmentResponse> {
